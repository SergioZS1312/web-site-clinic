...
import { CalendarDays, Clock3, Lightbulb, MessageCircle, Phone, ShieldCheck, Star } from 'lucide-react';
    ...
    <section className="relative overflow-hidden bg-secondary-900 px-6 py-20 md:px-[8%] md:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-6xl text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6">
          ...
          >
            <MessageCircle className="h-7 w-7 transition-transform duration-300 group-hover:rotate-12" strokeWidth={2.5} />
        ...
        <div className="mt-12 grid grid-cols-1 gap-4 sm:gap-6 md:mt-16 md:grid-cols-3">
          <div className="group border-l-4 border-primary-300 bg-surface-0/15 p-6 backdrop-blur-md transition-all duration-300 hover:bg-surface-0/25 hover:shadow-2xl sm:p-8">
            <div className="flex items-start gap-4 sm:gap-5">
              <div className="shrink-0 pt-0.5 transition-transform duration-300 group-hover:scale-110">
                <Phone className="h-10 w-10 text-primary-200 sm:h-12 sm:w-12" strokeWidth={2} />
              </div>
          ...
          <div className="group border-l-4 border-primary-300 bg-surface-0/15 p-6 backdrop-blur-md transition-all duration-300 hover:bg-surface-0/25 hover:shadow-2xl sm:p-8">
            <div className="flex items-start gap-4 sm:gap-5">
              <div className="shrink-0 pt-0.5 transition-transform duration-300 group-hover:scale-110">
                <Clock3 className="h-10 w-10 text-primary-200 sm:h-12 sm:w-12" strokeWidth={2} />
              </div>
              <div className="text-left">
          ...
          <div className="group border-l-4 border-primary-300 bg-surface-0/15 p-6 backdrop-blur-md transition-all duration-300 hover:bg-surface-0/25 hover:shadow-2xl sm:p-8">
            <div className="flex items-start gap-4 sm:gap-5">
              <div className="shrink-0 pt-0.5 transition-transform duration-300 group-hover:scale-110">
                <ShieldCheck className="h-10 w-10 text-primary-200 sm:h-12 sm:w-12" strokeWidth={2} />
              </div>
              <div className="text-left">
