...
const AboutSection = () => {
  ...
  const values = [
    ...
    {
      title: 'Experiencia',
      desc: 'Especialistas en rehabilitación y alto rendimiento',
      icon: (
        <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
    ...
    {
      title: 'Compromiso',
      desc: 'Seguimiento continuo y atención personalizada',
      icon: (
        <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
    ...
    <section id="nosotros" className="bg-muted-50 px-6 py-24 md:px-[8%] md:py-32">
      <div className="mx-auto max-w-7xl">
        ...
        <div className={sectionHeaderClass}>
          <h2 className={`${sectionTitleClass} text-primary-700`}>Sobre nosotros</h2>
        ...
        <div className="mt-20 grid grid-cols-1 gap-6 md:grid-cols-3">
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="text-center border-t-4 border-primary-600 bg-surface-0 p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
            >
