...
const FloatingWhatsApp = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 sm:bottom-8 sm:right-8">
      {/* Tooltip */}
      <div
        className={`transform whitespace-nowrap rounded-lg bg-primary-700 px-4 py-2 text-xs font-bold uppercase tracking-wide text-surface-0 shadow-xl transition-all duration-300 sm:text-sm ${
      ...
      >
        <MessageCircle className="h-8 w-8 text-surface-0 sm:h-9 sm:w-9" strokeWidth={2.5} />
